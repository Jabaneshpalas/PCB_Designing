...
//13327945/276794/2.50/2/3/TVS Diode Uni-directional
...
(library Library_1
	...
	(symbolDef "5.0SMDJ75A" (originalName "5.0SMDJ75A")
	...
	(compDef "5.0SMDJ75A" (originalName "5.0SMDJ75A") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "5.0SMDJ75A"))
		...
		(attr "Manufacturer_Part_Number" "5.0SMDJ75A")
		(attr "Description" "ESD Suppressors / TVS Diodes 5kW 75V 5% Uni-Directional")
		(attr "<Hyperlink>" "https://www.littelfuse.com/~/media/electronics/datasheets/tvs_diodes/littelfuse_tvs_diode_5_0smdj_datasheet.pdf.pdf")
		(attr "<Component Height>" "2.62")
		(attr "<STEP Filename>" "5.0SMDJ75A.stp")
